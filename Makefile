...
#    Updated: 2017/02/23 15:10:54 by dbreton          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC 			= camera.c cone.c cylinder.c light.c parser.c plane.c sphere.c events.c main.c parser_add_objs.c rt.c utils.c opencl.c hashtable.c
OBJ				= $(SRC:.c=.o)
